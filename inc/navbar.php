...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu computadoras y tablets -->
            <div class="col-xs-4">
                ...
                <p class="text-navbar tittles-pages-logo">EL FARO DE ALEJANDRIA</p>
            </div>
            <div class="col-xs-8">
                    ...
                    <div class="contenedor-tr">
                        ...
                        <?php
                            if(!$_SESSION['nombreAdmin']==""){
                                echo ' 
                                    <a href="configAdmin.php" class="table-cell-tdd">Administración</a>
                                    <a href="pedido.php" class="table-cell-tdd">Pedidos</a>
                                    <a href="#" class="table-cell-tdd carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                                        <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
                                    </a>
                                    <a href="#" class="table-cell-tdd" data-toggle="modal" data-target=".modal-logout">
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en EL FARO DE ALEJANDRIA</h4>
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">EL FARO DE ALEJANDRIA</h3>
