    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">EL FARO DE ALEJANDRIA</small></h1>
            </div>
            <!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation"><a href="#Graficos" role="tab" data-toggle="tab">Graficos</a></li>
            </ul>
                                      ...
                                      <tbody>
                                          <?php
                                            if(!$_SESSION['nombreAdmin']==""){
                                                $pedidoU=  ejecutarSQL::consultar("SELECT de.NumPedido, pr.NombreProd, pr.Marca, pr.Modelo, pr.Precio, de.CantidadProductos FROM venta ve, detalle de, producto pr WHERE de.CodigoProd=pr.CodigoProd and ve.NumPedido=de.NumPedido and ve.Estado='Pendiente' order by NumPedido");                                        
                                                ...
                                                $pedidoU=  ejecutarSQL::consultar("SELECT de.NumPedido, pr.NombreProd, pr.Marca, pr.Modelo, pr.Precio, de.CantidadProductos FROM venta ve, detalle de, producto pr WHERE de.CodigoProd=pr.CodigoProd and ve.NumPedido=de.NumPedido and ve.Usuario='".$nameClien."'");                                        
                                                while($peU=mysql_fetch_array($pedidoU)){
                                                    echo '
                                                        <div id="update-pedido">
                                                            <tr>
                ...
                <div role="tabpanel" class="tab-pane fade" id="Graficos">
                    <div class="row">
                        <div class="col-xs-12">
                            <br><br>
                            <div id="add-graph">
                                <h2 class="text-info text-center">Estadisticas</h2>
                                <?php
                                ...
                                $sql=ejecutarSQL::consultar("SELECT COUNT(p.codigoProd) Conteo,p.nombreProd from venta v,detalle d,producto p where v.NumPedido=d.NumPedido and d.CodigoProd=p.CodigoProd and d.Fecha >= (CURDATE() - INTERVAL 1 MONTH ) group by p.nombreProd");                            
                   //$sql=ejecutarSQL::consultar("SELECT * from detalle");
                                ...
                                $grafico->title->Set("Ultimos 30 dias");
                                $grafico->xaxis->title->Set("Codigo de Productos");
